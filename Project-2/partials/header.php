            ...
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item" href="/phptutorial/Project-2/">Python</a>
                        <a class="dropdown-item" href="/phptutorial/Project-2/">Javascript</a>
                        <a class="dropdown-item" href="/phptutorial/Project-2/">Bootstrap</a>
                        <a class="dropdown-item" href="/phptutorial/Project-2/">React</a>
                        <a class="dropdown-item" href="/phptutorial/Project-2/">PHP</a>
